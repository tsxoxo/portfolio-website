...
-   Look at that good work to get an overview of what You're gonna be working with: the artboards (if they look a bit blank, ensure the grid is visible with `shift + g`) and the styles.

To illustrate, here are mine, used:
