...
-   Look at that good work. Get an overview of what You're gonna be working with: the artboards and the styles. If the artboards look a bit blank, ensure the grid is visible with `shift + g`.

Here are mine, after some framing and adjusting:
